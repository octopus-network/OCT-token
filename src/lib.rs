...
impl Default for OCTToken {
    fn default() -> Self {
        panic!("The contract should be initialized before usage")
    }
}
...
impl OCTToken {
    ...
    pub fn new(owner_id: AccountId, total_supply: U128) -> Self {
        ...
        let mut ct = Self { accounts: LookupMap::new(b"a".to_vec()), total_supply };
        let mut account = ct.get_account(&owner_id);
        account.balance = total_supply;
        ct.set_account(&owner_id, &account);
        ct
    }
...
mod tests {
    ...
    fn test_new() {
        ...
        let contract = OCTToken::new(bob(), total_supply.into());
    ...
    fn test_default() {
        let context = get_context(carol());
        testing_env!(context);
        let _contract = OCTToken::default();
    }
    ...
    fn test_transfer() {
        ...
        let total_supply = 1_000_000_000_000_000u128;
        let mut contract = OCTToken::new(carol(), total_supply.into());
